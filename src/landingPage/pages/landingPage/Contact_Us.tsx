  ...
  return (
    <div className="bg-[#fbfbfb]">
      <div className="text-center my-5">
        <div className="font-bold sm:text-lg text_sm pt-10 pb-3">
          Contact Us
        </div>
      ...
      <div className="bg-white border py-2 px-3 grid grid-cols-1 sm:grid-cols-[40%_60%] gap-3">
            ...
            {contactdata.map((data, index) => {
              return (
                <div key={index} className="text-white flex text-justify py-5">
                  <div className="sm:text-2xl pr-5 text_sm">{data.img}</div>
                  <div>{data.number}</div>
                </div>
              );
            })}
